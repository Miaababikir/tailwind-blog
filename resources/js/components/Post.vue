    ...
    <div class="bg-white overflow-hidden shadow-md rounded-lg">
        ...
        <div class="p-6">
            <div>
                ...
                <a href="#" class="block text-gray-800 font-semibold text-2xl mt-2 hover:text-gray-600 hover:underline">I
                    Built A Successful Blog In One Year</a>
                <p class="text-sm text-gray-600 mt-2">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Molestie
